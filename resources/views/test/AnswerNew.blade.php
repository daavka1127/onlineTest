            ...
            <form id="frmNewQuestion" method="POST" action="">
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <input name="answers[]" id="txtAns1" type="text" class="form-control" />
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <input name="answers[]" id="txtAns2" type="text" class="form-control" />
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <input name="answers[]" id="txtAns3" type="text" class="form-control" />
                        </div>
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <input name="answers[]" id="txtAns4" type="text" class="form-control" />
                        </div>
                    </div>
                </div>
            </form>
